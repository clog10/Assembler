...
DATAS SEGMENT
    COLX DB 29H ;Posicion de la columna
      ...
      COLX2 DB 13H ;Posicion de la columna Triangulo 2
      FILY2 DB 5 ; Posicion de la fila Triangulo 2
      ACUM2 DB 45 ;Cantidad de Asteriscos Inicial Triangulo 2
      cad1 db 'ESTRELLA UTILIZANDO LOOP',10,13,'$'
DATAS ENDS
CODE SEGMENT 'CODE'
    ...
    PRINC PROC FAR
        ...
        MOV CX,12 ;ciclo 1, 12 veces
        
        CICLO_1:;INICIO CICLO 1
            PUSH CX ;guardar valor del ciclo 1
            MOV CL,ACUM ; ciclo 2, cantidad de * a imprimir
            ...
            ADD ACUM,4 ;aumentamos la cantidad de asteriscos a imprimir
            INC FILY   ;Incrementamos el valor de la fila
            SUB COLX,2  ;Decrementamos el valor de la columna
            CURSOR COLX,FILY ;Llamamos nuevamente el m?todo
                             ;con las nuevas posiciones del cursor
            POP CX  ;decrementar el valor del registro
        ...
        CICLO_12:;INICIO CICLO 1
            PUSH CX ;guardar valor del ciclo 1
            MOV CL,ACUM2 ; ciclo 2, cantidad de * a imprimir
            CICLO_22:;INICIO CICLO 2
                ...
                SUB ACUM2,4 ;Decrementamos el valor de la cantidad
                            ; de * a imprimir
                INC FILY2   ;Incrementamos el valor de la fila
                ADD COLX2,2 ;Incrementamos el valor de la columna
